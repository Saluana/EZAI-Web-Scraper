...
function fetchNotes(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var URI, openAiKey, textContent, title, page, error_1, splitContent, completeNotes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, openaiPrompts_1.default.getNotes(splitContent, openAiKey)];
                case 5:
                    completeNotes = _a.sent();
                    ...
                    if (!(0, instanceCheck_1.instanceOfSuccess)(completeNotes))
                        return [2 /*return*/, res.json(completeNotes)];
                    if (completeNotes.notes.length > 0) {
                        return [2 /*return*/, res.status(200).json({ status: "success", message: "Notes Created", notes: completeNotes, title: title })];
                    }
                    else {
                        return [2 /*return*/, res.status(200).json({ status: "failure", message: "No Notes Found" })];
                    }
                    return [2 /*return*/];
            }
        });
