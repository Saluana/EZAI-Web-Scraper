            ...
            messages: [
                {
                    ...
                    role: 'system',
                    content:
                        'Quickly write a very short and concise summary of the text provided by the user. The summary should be no longer then a Tweet. Remove any unwanted text, such as things related to website cookies, website newletters, and website advertisements.',
                },
                {
                    //RULES
                    role: 'user',
